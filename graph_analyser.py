...
uploaded_file = st.sidebar.file_uploader("Upload CSV/XLSX", type=["csv", "xls", "xlsx"])
rain_toggle = st.sidebar.checkbox("Include Rainfall", value=True)

tabs = st.tabs(["📊 Graph", "📈 Summary", "🖨 Export"])
    ...
    with tabs[2]:
        ...
        if st.button("Export PDF"):
            ...
            if os.path.exists("Moniteye+Logo+Correct+Blue.jpeg"):
                ...
                pdf.ln(30)
            pdf.cell(200, 10, txt="Structural Movement Report", ln=True)
